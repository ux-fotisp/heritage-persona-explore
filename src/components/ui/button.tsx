  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-primary text-primary-foreground hover:shadow-soft transform hover:scale-105 transition-spring shadow-button",
        sage: "bg-sage text-sage-foreground hover:bg-sage/90 shadow-button",
        coral: "bg-coral text-coral-foreground hover:bg-coral/90 shadow-button",
        gradient: "bg-gradient-primary text-primary-foreground hover:shadow-soft transition-spring shadow-button",
      },
      size: {
